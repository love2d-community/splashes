...
init = ->
  ...
  flux.to(stripes, 0.3, radius: 170)\ease("linear")\delay(0.6)\after(
    0.2, radius: 70)\ease "backout"
init!

stencil = ->
  lg.circle "fill", width/2, height/2, stripes.radius, stripes.radius*80
...
love.draw = ->
  ...
  lg.draw heart.sprite, 0, 5, heart.rot, heart.scale, heart.scale, 43, 39
